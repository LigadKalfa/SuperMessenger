...
// Intended to be an item in the AllChats collection view.
class ChatCell: BaseCell{
    ...
    override func setupViews() {
        ...
        profileImageView.image = UIImage(named: "someProfile.jpeg")
        hasReadImageView.image = UIImage(named: "someProfile.jpeg")
